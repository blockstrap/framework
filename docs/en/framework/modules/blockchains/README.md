...
* [`$.fn.blockstrap.blockchains.send`(to_address, to_amount, from_address, keys, callback, blockchain, data, fee)](#blockchains_send)
...
#### `blockchains.send`(to_address, to_amount, from_address, keys, callback, blockchain, data, fee) <a name="blockchains_send" class="pull-right" href="#docs_home"><i class="glyphicon glyphicon-upload"></i>- back to top</a>
